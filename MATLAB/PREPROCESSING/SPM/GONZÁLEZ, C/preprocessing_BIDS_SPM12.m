...
22/12/2022 v.1.0.1: - adapted to antivea task

Carlos Gonzalez-Garcia (cgonzalez at ugr dot es)
    %}
...
specify the paramters of your dataset here
    ...
    basedir = '/mnt/NeuroNas/carlos/ANTI-VEA_fMRI/fmri/BIDS';
    ...
    derivativesdir = '/mnt/NeuroNas/carlos/ANTI-VEA_fMRI/fmri/derivatives';
    subdir=['/sub-' substr];
    mkdir([regexprep([basedir subdir],'BIDS','derivatives') '/anat'])
    ...
    if do_deface
        ...
        matlabbatch{1}.spm.util.deface.images = cellstr(spm_select('FPList',[basedir subdir '/anat/'],'^sub.*T1w.nii$'));
        spm_jobman('run', matlabbatch);
        clear matlabbatch;
        % file management
        % delete original file with the face still intact
        delete (spm_select('FPList',[basedir subdir '/anat/'],'^sub.*T1w.nii$'));
    ...
    if do_fieldmap
        ...
        matlabbatch{1}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.mflags.template = {'/usr/local/MATLAB/R2021a/toolbox/spm12/toolbox/FieldMap/T1.nii'};
    ...
    if do_segment == 1
        ...
        matlabbatch{1}.spm.spatial.preproc.tissue(1).tpm = {'/usr/local/MATLAB/R2021a/toolbox/spm12/tpm/TPM.nii,1'};
        matlabbatch{1}.spm.spatial.preproc.tissue(1).ngaus = 1;
        matlabbatch{1}.spm.spatial.preproc.tissue(1).native = [1 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(1).warped = [0 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(2).tpm = {'/usr/local/MATLAB/R2021a/toolbox/spm12/tpm/TPM.nii,2'};
        matlabbatch{1}.spm.spatial.preproc.tissue(2).ngaus = 1;
        matlabbatch{1}.spm.spatial.preproc.tissue(2).native = [1 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(2).warped = [0 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(3).tpm = {'/usr/local/MATLAB/R2021a/toolbox/spm12/tpm/TPM.nii,3'};
        matlabbatch{1}.spm.spatial.preproc.tissue(3).ngaus = 2;
        matlabbatch{1}.spm.spatial.preproc.tissue(3).native = [1 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(3).warped = [0 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(4).tpm = {'/usr/local/MATLAB/R2021a/toolbox/spm12/tpm/TPM.nii,4'};
        matlabbatch{1}.spm.spatial.preproc.tissue(4).ngaus = 3;
        matlabbatch{1}.spm.spatial.preproc.tissue(4).native = [1 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(4).warped = [0 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(5).tpm = {'/usr/local/MATLAB/R2021a/toolbox/spm12/tpm/TPM.nii,5'};
        matlabbatch{1}.spm.spatial.preproc.tissue(5).ngaus = 4;
        matlabbatch{1}.spm.spatial.preproc.tissue(5).native = [1 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(5).warped = [0 0];
        matlabbatch{1}.spm.spatial.preproc.tissue(6).tpm = {'/usr/local/MATLAB/R2021a/toolbox/spm12/tpm/TPM.nii,6'};
